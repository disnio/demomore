<template>
  <div class="home">
    <h1>Super Table 测试</h1>
    <p>{{n}}</p>
    <div style="padding-bottom: 10px">
      <el-button @click="save">保存</el-button>
      <el-button @click="reset">重置</el-button>
      <el-button @click="ccc('+')">加</el-button>
      <el-button @click="ccc('-')">减</el-button>
      <el-button @click="ccc('/')">除</el-button>
      <el-button @click="ccc('t')">四舍五入两位</el-button>
    </div>
    <tb
      ref="tb"
      :data="dataList"
