    ...
    <div class="jz-box">
        ...
        @click="zhezhao = false"
         /> -->
          <div class="btn-box2">
            <button class="prev" @click="getPrev" v-if="!isFirst">上一个</button>
            <button class="correct" @click="getNext('正确')" v-show="looklike <= 60 && childSentence.trim().length !== 0">
                <div class="icon">
            ...
            <button class="correct" @click="getNext('错误')" v-show="looklike > 60 || childSentence.trim().length == 0">
                <div class="icon">
