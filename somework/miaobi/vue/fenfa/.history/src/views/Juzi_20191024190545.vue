    ...
    <div class="jz-box">
        ...
        @click="zhezhao = false"
         /> -->
          <div class="btn-box2">
            <button class="prev" @click="getPrev" v-if="!isFirst">上一个</button>
            <button class="correct" @click="getNext('正确')" v-show="!isLast && looklike <= 60 && childSentence.trim().length !== 0">
                <div class="icon">
            ...
            <button class="correct" @click="getNext('错误')" v-show="!isLast && looklike > 60 || childSentence.trim().length == 0">
                <div class="icon">
                    <img src="../assets/yes11.png" alt="" v-show="tag==='错误'"/>
                    <img src="../assets/yes1.png" alt="" v-show="tag!=='错误'"/>
                </div>
                <p class="text" v-if="taskGroupStatus!==7">改好了2</p>
                <p class="text" v-if="taskGroupStatus==7">正确</p>
            </button>
...
<script>
    ...
    import {Field, CellGroup, Toast, NavBar, Popup, RadioGroup, Overlay } from 'vant';
