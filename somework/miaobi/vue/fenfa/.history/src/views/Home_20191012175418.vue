    ...
    <div class="home">
        <div class="home-box" id="swrapper" ref="wrapper">
            <div id="scroller">
                ...
                <div class="home-title1">
                    我的任务单
                    <div class="shenqing-btn fr"
                         v-model="dialogFormVisible && radio"
                         position="top"
                         :style="{ height:'20%'}"
                         @click="toApplyTask">
                        申请任务
...
<script>
    ...
    import {NavBar, Dialog, Toast, Progress, Panel, Button, RadioGroup, Radio} from 'vant';
    ...
    export default {
        ...
        methods: {
            ...
            // 接受任务
            acceptedTask(task) {
                this.acceptTask({tId: task.id}).then(() => {
