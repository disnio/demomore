    ...
    <el-row>
      <el-col :span="2">
        ...
        >
          ...
          <!-- <el-menu-item index="/suppliers" v-if="isSuper">
            <span slot="title">供应商管理</span>
          </el-menu-item> -->

          <el-submenu>
            <template slot="title" style="text-align:left;">供应商</template>
             <el-menu-item-group>
              <el-menu-item index="/suppliers" style="padding-left:50px;">供应商管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="/suppliers/achivement" style="padding-left:50px;">业务统计</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
      </el-col>
