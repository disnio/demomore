    ...
    <el-row>
        ...
        <el-col :span="22" :offset="1">
            <el-table
                ...
                <el-table-column prop="number" label="任务单号" width="120">
                    <template slot-scope="scope">
                        <a :href="`/detail/${scope.row.number}`">{{ scope.row.number }}</a>
                     
                    </template>
                </el-table-column>
                <el-table-column prop="name" label="任务名称">
                        <template slot-scope="scope">
                        <a :href="`/detail/${scope.row.name}`">{{ scope.row.name }}</a>
                     
                    </template>
                </el-table-column>
                <el-table-column prop="type" label="类型" width="94"></el-table-column>
                <el-table-column prop="wayOfAccept" label="方式" width="80"></el-table-column>
                <el-table-column prop="price" label="价格" width="80"></el-table-column>
                <el-table-column prop="sentenceCount" label="数量" width="60"></el-table-column>
                <!-- todo -->
                ...
                <el-table-column prop="leaveTime" label="剩余时间" width="100"></el-table-column>
                ...
                <el-table-column label="操作" :width="czwidth">
                    <template slot-scope="scope">
