    ...
    <el-row>
        ...
        <el-col :span="22" :offset="1">
            <el-table
                ...
                <el-table-column prop="wayOfAccept" label="相似度" width="80"></el-table-column>
                <el-table-column prop="price" label="标记结果" width="80"></el-table-column>
                <el-table-column prop="sentenceCount" label="通顺度" width="60"></el-table-column>
                <!-- todo -->
                ...
                <el-table-column prop="submitDt" label="完成时间时间" width="100">
