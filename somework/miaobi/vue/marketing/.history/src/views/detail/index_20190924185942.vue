    ...
    <el-row>
        ...
        <el-col :span="22" :offset="1">
            <el-table
                ...
                <el-table-column prop="similarity" label="相似度" sortable width="90"></el-table-column>
                ...
                <el-table-column prop="finishedDtStamp" label="完成时间" sortable width="105">
                ...
                <el-table-column prop="writerName" label="完成人" width="100"></el-table-column>
                 <el-table-column prop="auditDtStamp" label="审核时间" sortable width="105">
                    <template slot-scope="scope">
                        <p>{{ scope.row.submitDt[0] }}</p>
                        <p>{{ scope.row.submitDt[1] }}</p>
                    </template>
