            ...
            <el-row>
                ...
                <el-col :span="14" style="text-aling:right;">
                    <div class="btn-box">
                        ...
                        <button class="next" :disabled="sub" @click="getNext('正确')"  v-if="taskGroupStatus==7">正确</button>
                        <button class="next" :disabled="sub" @click="getNext('错误')"  v-if="taskGroupStatus==7">错误</button>
                        <button class="next" :disabled="sub" @click="getNext('正确')"  v-if="taskGroupStatus!==7">改好了</button>
                        <button class="next" :disabled="sub" @click="getNext('错误')"  v-if="taskGroupStatus!==7">改不了</button>
                    </div>
                </el-col>
            </el-row>
