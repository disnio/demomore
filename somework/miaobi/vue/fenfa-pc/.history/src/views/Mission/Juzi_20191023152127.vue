            ...
            <el-row>
                ...
                <el-col :span="14" style="text-aling:right;">
                    <div class="btn-box">
                        ...
                        <button class="next" @click="getNext('正确')" v-show="!isLast && taskGroupStatus!==7">下一个</button>
                        <button class="next" @click="getNext('错误')" v-show="!isLast && taskGroupStatus!==7 && looklike > 60">下一个</button>
