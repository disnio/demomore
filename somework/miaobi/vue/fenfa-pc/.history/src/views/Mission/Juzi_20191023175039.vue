            ...
            <el-row>
                ...
                <el-col :span="14" style="text-aling:right;">
                    <div class="btn-box">
                        ...
                        <button class="next" @click="getNext('正确')" v-if="!isLast  && taskGroupStatus!==7 && looklike < 60 && childSentence.trim().length !== 0">正确</button>
                        <button class="next" @click="getNext('正确')" v-if="!isLast">正确</button>
                        <button class="next" @click="getNext('错误')" v-if="!isLast && taskGroupStatus!==7">错误</button>
                        <button class="next" @click="getNext('错误')" v-if="!isLast && taskGroupStatus!==7">错误</button>
