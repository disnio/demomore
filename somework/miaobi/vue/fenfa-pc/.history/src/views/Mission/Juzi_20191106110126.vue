            ...
            <el-row>
                ...
                <el-col :span="14" style="text-aling:right;">
                    <div class="btn-box">
                        ...
                        <button class="next"
                        :disabled="sub"
                                @click="getNext('正确')" v-show="taskGroupStatus==7">正确</button>
                        <button class="next"
                        :disabled="sub"
                                @click="getNext('错误')" v-show="taskGroupStatus==7">错误</button>

                        <button class="next"
                        :disabled="sub"
                                @click="getNext('正确')"
                                v-show="taskGroupStatus!==7 && looklike <= 60 && childSentence.trim().length !== 0">改好了
                        </button>
                        <button class="next"
                        :disabled="sub"
                                @click="getNext('错误')"
                        ...
                        <button class="next"
                        :disabled="sub"
                                @click="getNext('错误')" v-show="taskGroupStatus!==7">改不了</button>
        ...
        methods: {
            ...
            getNext(tag) {
                ...
                this.saveAndGet({
                    ...
                    this.sub = false;
                   getNext{emulateJSON:true,_timeout:3000,
                        onTimeout: (request) => {
                            //超出时间你要处理的逻辑
