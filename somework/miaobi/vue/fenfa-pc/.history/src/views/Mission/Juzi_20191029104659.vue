            ...
            <el-row>
                ...
                <el-col :span="14" style="text-aling:right;">
                    <div class="btn-box">
                        ...
                        <button class="next" @click="getNext('正确')" v-show="looklike <= 60 && childSentence.trim().length !== 0">改好了</button>
                        <button class="next" @click="getNext('错误')" v-show="looklike > 60 || childSentence.trim().length == 0">改好了</button>
                        <button class="next" @click="getNext('错误')"  v-show="taskGroupStatus!==7">错误</button>
