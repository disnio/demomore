            ...
            <el-row>
                ...
                <el-col :span="14" style="text-aling:right;">
                    <div class="btn-box">
                        ...
                        <button class="next" @click="getNext('正确')" v-show="!isLast && taskGroupStatus!==7 && looklike < 60">下一个</button>
                        <button class="next" @click="getNext('错误')" v-show="!isLast && taskGroupStatus!==7 && looklike > 60 || childSentence.trim().length == 0">下一个2</button>

                        <button class="next" @click="getNext('正确')" v-if="taskGroupStatus===7">正确</button>
                        <button class="next" @click="getNext('错误')" v-if="taskGroupStatus===7">错误</button>
...
<script>
    ...
    import {Col, Row, Input, InputNumber} from "element-ui";
