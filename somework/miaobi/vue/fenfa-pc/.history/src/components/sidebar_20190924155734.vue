                ...
                <el-menu
                    ...
                    <el-menu-item-group style="padding-left:30px;">
                        ...
                        <el-menu-item
                                ...
                                v-if="userinfo && userinfo.scoringTaskCount">改写句子对
                        </el-menu-item>
                        ...
                        <el-menu-item
                                ...
                                v-if="userinfo && userinfo.scoringTaskCount">评价句子对
                        </el-menu-item>

                        <el-menu-item
                                :index="`/wan/${pathId.audit}`"
                                :class="{menuactive:($route.path===`/wan/${pathId.audit}`|| $route.path.includes('shenhex'))}"
                                v-if="userinfo && userinfo.similarSentencePairReviewTaskCount">审核句子对
                        </el-menu-item>
                    </el-menu-item-group>
